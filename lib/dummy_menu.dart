...
var foodMenuList = [
  ...
  FoodMenu(
      ...
      imageUrls: [
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSa2a8VQR0lXQC5ocHCtXH8Ak56luo9Cb_vig&s'
      ]),
  FoodMenu(
    name: 'Bakso',
    category: 'Soup',
  ...
  FoodMenu(
    ...
    imageUrls: ['https://example.com/images/nasi-uduk1.jpg'],
  ),
  FoodMenu(
    name: 'Soto Betawi',
    category: 'Main Course',
    ...
    imageUrls: ['https://example.com/images/soto-betawi1.jpg'],
  ),
  FoodMenu(
    name: 'Pempek',
    category: 'Snack',
    ...
    imageUrls: ['https://example.com/images/pempek1.jpg'],
  ),
  FoodMenu(
    name: 'Nasi Liwet',
    category: 'Main Course',
    ...
    imageUrls: ['https://example.com/images/nasi-liwet1.jpg'],
  ),
  FoodMenu(
    name: 'Martabak Telur',
    category: 'Snack',
    ...
    imageUrls: ['https://example.com/images/martabak-telur1.jpg'],
  ),
  FoodMenu(
    name: 'Bubur Ayam',
    category: 'Breakfast',
    ...
    imageUrls: ['https://example.com/images/bubur-ayam1.jpg'],
  ),
  FoodMenu(
    name: 'Es Cendol',
    category: 'Dessert',
    ...
    imageUrls: ['https://example.com/images/es-cendol1.jpg'],
  ),
  FoodMenu(
    name: 'Gulai Kambing',
    category: 'Main Course',
    ...
    imageUrls: ['https://example.com/images/gulai-kambing1.jpg'],
  ),
  FoodMenu(
    name: 'Kerak Telor',
    category: 'Snack',
    ...
    imageUrls: ['https://example.com/images/kerak-telor1.jpg'],
  ),
];
